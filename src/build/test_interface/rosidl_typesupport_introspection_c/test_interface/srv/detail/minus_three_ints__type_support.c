...
#include <stddef.h>
#include "test_interface/srv/detail/minus_three_ints__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  test_interface__srv__MinusThreeInts_Request__init(message_memory);
}
...
{
  test_interface__srv__MinusThreeInts_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MinusThreeInts_Request__rosidl_typesupport_introspection_c__MinusThreeInts_Request_message_member_array[3] = {
  {
    ...
    offsetof(test_interface__srv__MinusThreeInts_Request, a),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_interface__srv__MinusThreeInts_Request, b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_interface__srv__MinusThreeInts_Request, c),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MinusThreeInts_Request__rosidl_typesupport_introspection_c__MinusThreeInts_Request_message_members = {
  "test_interface__srv",  // message namespace
  "MinusThreeInts_Request",  // message name
  3,  // number of fields
  sizeof(test_interface__srv__MinusThreeInts_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interface, srv, MinusThreeInts_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  test_interface__srv__MinusThreeInts_Response__init(message_memory);
}
...
{
  test_interface__srv__MinusThreeInts_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MinusThreeInts_Response__rosidl_typesupport_introspection_c__MinusThreeInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_interface__srv__MinusThreeInts_Response, sum),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MinusThreeInts_Response__rosidl_typesupport_introspection_c__MinusThreeInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(test_interface__srv__MinusThreeInts_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_test_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interface, srv, MinusThreeInts_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_members = {
  "test_interface__srv",  // service namespace
  "MinusThreeInts",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_Request_message_type_support_handle,
  NULL  // response message
  // test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_Response_message_type_support_handle
};

static rosidl_service_type_support_t test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_type_support_handle = {
  0,
  &test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interface, srv, MinusThreeInts)() {
  if (!test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_type_support_handle.typesupport_identifier) {
    test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interface, srv, MinusThreeInts_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interface, srv, MinusThreeInts_Response)()->data;
  }

  return &test_interface__srv__detail__minus_three_ints__rosidl_typesupport_introspection_c__MinusThreeInts_service_type_support_handle;
}
