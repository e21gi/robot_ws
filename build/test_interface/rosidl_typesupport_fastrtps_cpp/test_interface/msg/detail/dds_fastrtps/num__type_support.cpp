...
#include "test_interface/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const test_interface::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_interface::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
...
{
  auto typed_message =
    static_cast<const test_interface::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_interface::msg::Num *>(
    untyped_ros_message);
...
{
  return &test_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interface, msg, Num)() {
  return &test_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
